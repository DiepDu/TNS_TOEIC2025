...
namespace TNS.DBConnection
{
    public class Connecting
    {
        ...
        public static string SQL_MainDatabase = @"Data Source=LAPTOP-1HA2HB97;Initial Catalog=TNS_Toeic;User ID=sa;Password=Vnhki333;MultipleActiveResultSets=True;Encrypt=False;TrustServerCertificate=True";
    }
}