...
namespace TNS_TOEICPart1.Areas.TOEICPart1.Pages
{
    ...
    public class QuestionModel : PageModel
    {
        ...
        public IActionResult OnPostRecordRead([FromBody] ItemRequest request)
        {
            ...
            {
                QuestionAccessData.Part1_Question_Info zRecord;
                if (string.IsNullOrEmpty(request.QuestionKey) || request.QuestionKey.Length != 36)
                    zRecord = new QuestionAccessData.Part1_Question_Info();
                else
                    zRecord = new QuestionAccessData.Part1_Question_Info(request.QuestionKey);
        ...
        public IActionResult OnPostRecordCreate()
        {
            ...
            var zRecord = JsonSerializer.Deserialize<QuestionAccessData.Part1_Question_Info>(recordJson);
        ...
        public IActionResult OnPostRecordDel([FromBody] ItemRequest request)
        {
            ...
            if (IsFullAdmin || UserLogin.Role.IsDelete)
            {
                ...
                {
                    QuestionAccessData.Part1_Question_Info zRecord = new QuestionAccessData.Part1_Question_Info();
