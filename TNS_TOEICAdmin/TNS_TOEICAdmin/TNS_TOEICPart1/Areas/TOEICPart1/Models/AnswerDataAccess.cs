...
namespace TNS_TOEICPart1.Areas.TOEICPart1.Models
{
    public class AnswerDataAccess
    {
        public class Part1_Answer_Info
        {
            ...
            public Part1_Answer_Info(string questionKey)
            {
            ...
            public Part1_Answer_Info(string answerKey, string questionKey)
            {
                ...
                string sql = "SELECT * FROM [dbo].[TEC_Part1_Answer] WHERE AnswerKey = @AnswerKey AND RecordStatus != 99";
                    ...
                    using (var cmd = new SqlCommand(sql, conn))
                    {
                        ...
                        using (var reader = cmd.ExecuteReader())
                        {
                            if (reader.HasRows)
                            {
                                ...
                                _GrammarTopic = reader["GrammarTopic"]?.ToString() ?? ""; 
            ...
            public void Delete()
            {
                ...
                string sql = "UPDATE [dbo].[TEC_Part1_Answer] SET RecordStatus = 99 WHERE AnswerKey = @AnswerKey AND RecordStatus != 99";
                string connectionString = TNS.DBConnection.Connecting.SQL_MainDatabase;
                using (var conn = new SqlConnection(connectionString))
                {
                    try
