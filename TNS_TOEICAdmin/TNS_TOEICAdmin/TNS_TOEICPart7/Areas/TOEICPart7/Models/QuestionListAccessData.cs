...
namespace TNS_TOEICPart7.Areas.TOEICPart7.Models
{
    public static class QuestionListDataAccess
    {
        ...
        // ===== ✅ THÊM CÁC PHƯƠNG THỨC VALIDATION MỚI CHO PART7 =====
        ...
        /// ✅ PART7 SPECIFIC: Requires minimum 4 sub-questions (same as Part6)
        /// </summary>
        public static List<string> ValidateChildQuestions(string parentQuestionKey)
        {
            ...
            try
            {
                using (SqlConnection zConnect = new SqlConnection(zConnectionString))
                {
                    ...
                    // ✅ PART7: Phải có ít nhất 4 câu hỏi con (giống Part6)
                    if (childCount < 4)
                    {
