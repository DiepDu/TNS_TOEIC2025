    ...
    public class QuestionAccessData
    {
        public class Part7_Question_Info
        {
            ...
            public string Create()
            {
                ...
                string zSQL = "INSERT INTO [dbo].[TEC_Part7_Question] (QuestionKey, QuestionImage, QuestionText, QuestionVoice,Explanation, SkillLevel, Ranking,Parent, Publish, RecordStatus, CreatedBy, CreatedName, ModifiedBy, ModifiedName, Category, GrammarTopic, VocabularyTopic, ErrorType) " +
