    ...
    public class QuestionAccessData
    {
        public class Part4_Question_Info
        {
            ...
            public string Create()
            {
                ...
                string zSQL = "INSERT INTO [dbo].[TEC_Part4_Question] (QuestionKey, QuestionImage, QuestionText, QuestionVoice,Explanation, SkillLevel, Ranking,Parent, Publish, RecordStatus, CreatedBy, CreatedName, ModifiedBy, ModifiedName, Category, GrammarTopic, VocabularyTopic, ErrorType) " +
