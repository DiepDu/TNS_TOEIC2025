...
namespace TNS_TOEICPart4.Areas.TOEICPart4.Models
{
    ...
    {
        public class Part4_Answer_Info
        {
            #region [Fields]
            ...
            public Part4_Answer_Info(string questionKey)
            {
            ...
            public Part4_Answer_Info(string answerKey, string questionKey)
            {
                ...
                string sql = "SELECT * FROM [dbo].[TEC_Part4_Answer] WHERE AnswerKey = @AnswerKey AND RecordStatus != 99";
            ...
            public void Create()
            {
                ...
                string sql = @"INSERT INTO [dbo].[TEC_Part4_Answer] 
            ...
            public void Delete()
            {
                ...
                string sql = "UPDATE [dbo].[TEC_Part4_Answer] SET RecordStatus = 99 WHERE AnswerKey = @AnswerKey AND RecordStatus != 99";
                string connectionString = TNS.DBConnection.Connecting.SQL_MainDatabase;
                using (var conn = new SqlConnection(connectionString))
                {
                    try
