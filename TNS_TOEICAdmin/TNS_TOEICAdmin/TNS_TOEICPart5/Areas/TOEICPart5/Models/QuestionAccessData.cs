...
namespace TNS_TOEICPart5.Areas.TOEICPart5.Models
{
    ...
    {
        public class Part5_Question_Info
        {
            #region [ Field Name ]
            ...
            public Part5_Question_Info()
            {
                Guid zNewID = Guid.NewGuid();
                _QuestionKey = zNewID.ToString();
                _IsNewRecord = true;
            }
            public Part5_Question_Info(string QuestionKey)
            {
                ...
                string zSQL = "SELECT * FROM [dbo].[TEC_Part5_Question] WHERE QuestionKey = @QuestionKey";
            ...
            {
                string zResult = "";
                string zSQL = "UPDATE [dbo].[TEC_Part5_Question] Set RecordStatus = 99 WHERE QuestionKey = @QuestionKey";
                string zConnectionString = TNS.DBConnection.Connecting.SQL_MainDatabase;
                SqlConnection zConnect = new SqlConnection(zConnectionString);
                zConnect.Open();
                try
            ...
            {
                string zResult = "";
                string zSQL = "DELETE FROM [dbo].[TEC_Part5_Question] WHERE QuestionKey = @QuestionKey";
                string zConnectionString = TNS.DBConnection.Connecting.SQL_MainDatabase;
                SqlConnection zConnect = new SqlConnection(zConnectionString);
                zConnect.Open();
                try
