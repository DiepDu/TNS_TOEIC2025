...
namespace TNS_TOEICPart6.Areas.TOEICPart6.Models
{
    ...
    {
        public class Part6_Answer_Info
        {
            #region [Fields]
            ...
            public Part6_Answer_Info(string questionKey)
            {
            ...
            public Part6_Answer_Info(string answerKey, string questionKey)
            {
                ...
                string sql = "SELECT * FROM [dbo].[TEC_Part6_Answer] WHERE AnswerKey = @AnswerKey AND RecordStatus != 99";
            ...
            public void Create()
            {
                ...
                string sql = @"INSERT INTO [dbo].[TEC_Part6_Answer] 
            ...
            public void Delete()
            {
                ...
                string sql = "UPDATE [dbo].[TEC_Part6_Answer] SET RecordStatus = 99 WHERE AnswerKey = @AnswerKey AND RecordStatus != 99";
                string connectionString = TNS.DBConnection.Connecting.SQL_MainDatabase;
                using (var conn = new SqlConnection(connectionString))
                {
                    try
