...
namespace TNS_TOEICPart3.Areas.TOEICPart3.Models
{
    ...
    {
        public class Part3_Answer_Info
        {
            #region [Fields]
            ...
            public Part3_Answer_Info(string questionKey)
            {
            ...
            public Part3_Answer_Info(string answerKey, string questionKey)
            {
                ...
                string sql = "SELECT * FROM [dbo].[TEC_Part3_Answer] WHERE AnswerKey = @AnswerKey AND RecordStatus != 99";
            ...
            public void Create()
            {
                ...
                string sql = @"INSERT INTO [dbo].[TEC_Part3_Answer] 
            ...
            public void Delete()
            {
                ...
                string sql = "UPDATE [dbo].[TEC_Part3_Answer] SET RecordStatus = 99 WHERE AnswerKey = @AnswerKey AND RecordStatus != 99";
                string connectionString = TNS.DBConnection.Connecting.SQL_MainDatabase;
                using (var conn = new SqlConnection(connectionString))
                {
                    try
